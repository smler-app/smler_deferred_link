package io.smler.deferred_link
...
/**
 * Android implementation for `smler_deferred_link`.
 *
 * Responsibilities:
 ...
 */
class SmlerDeferredLinkPlugin : FlutterPlugin, MethodCallHandler {
    ...
    companion object {
        private const val TAG = "SmlerDeferredLink"
        private const val CHANNEL_NAME = "io.smler.deferred_link"
    }
}
